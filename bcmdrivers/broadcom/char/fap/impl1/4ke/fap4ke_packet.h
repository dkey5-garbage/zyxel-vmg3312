...
/* 63268, IPV6, BPM */
#define FAP4KE_PKT_MAX_DSP_FLOWS         54
#define FAP4KE_PKT_MAX_PSM_FLOWS         44  
#define FAP4KE_PKT_MAX_QSM_FLOWS         124
#define FAP4KE_PKT_CMDLISTS_IN_PSM       0
#define FAP4KE_PKT_CMDLISTS_IN_QSM       222
#else /* CC_FAP4KE_PKT_IPV6_SUPPORT */
/* 63268, IPV4, BPM */
#define FAP4KE_PKT_MAX_DSP_FLOWS         75
#define FAP4KE_PKT_MAX_PSM_FLOWS         65
#define FAP4KE_PKT_MAX_QSM_FLOWS         214
#define FAP4KE_PKT_CMDLISTS_IN_PSM       0
#define FAP4KE_PKT_CMDLISTS_IN_QSM       354
#endif /* else CC_FAP4KE_PKT_IPV6_SUPPORT */
#else /* BPM or IQ */
#if defined(CC_FAP4KE_PKT_IPV6_SUPPORT)
/* 63268, IPV6, no BPM */
#define FAP4KE_PKT_MAX_DSP_FLOWS         63
#define FAP4KE_PKT_MAX_PSM_FLOWS         108
#define FAP4KE_PKT_MAX_QSM_FLOWS         89
#define FAP4KE_PKT_CMDLISTS_IN_PSM       0
#define FAP4KE_PKT_CMDLISTS_IN_QSM       260
#else /* CC_FAP4KE_PKT_IPV6_SUPPORT */
/* 63268, IPV4, no BPM */
#define FAP4KE_PKT_MAX_DSP_FLOWS         92
#define FAP4KE_PKT_MAX_PSM_FLOWS         161
#define FAP4KE_PKT_MAX_QSM_FLOWS         169
#define FAP4KE_PKT_CMDLISTS_IN_PSM       0
#define FAP4KE_PKT_CMDLISTS_IN_QSM       422
...
#if defined(CC_FAP4KE_PKT_IPV6_SUPPORT)
/* 6362 IPV6, BPM */
#define FAP4KE_PKT_MAX_DSP_FLOWS         44
#define FAP4KE_PKT_MAX_PSM_FLOWS         20
#define FAP4KE_PKT_MAX_QSM_FLOWS         0
#define FAP4KE_PKT_CMDLISTS_IN_PSM       62
#define FAP4KE_PKT_CMDLISTS_IN_QSM       2
#else /* CC_FAP4KE_PKT_IPV6_SUPPORT */
/* 6362 IPV4, BPM */
#define FAP4KE_PKT_MAX_DSP_FLOWS         62
#define FAP4KE_PKT_MAX_PSM_FLOWS         42
#define FAP4KE_PKT_MAX_QSM_FLOWS         0
#define FAP4KE_PKT_CMDLISTS_IN_PSM       98
#define FAP4KE_PKT_CMDLISTS_IN_QSM       6
#endif /* else CC_FAP4KE_PKT_IPV6_SUPPORT */
#else /* BPM or IQ */
#if defined(CC_FAP4KE_PKT_IPV6_SUPPORT)
/* 6362 IPV6, no BPM */
#define FAP4KE_PKT_MAX_DSP_FLOWS         53
#define FAP4KE_PKT_MAX_PSM_FLOWS         45
#define FAP4KE_PKT_MAX_QSM_FLOWS         0
#define FAP4KE_PKT_CMDLISTS_IN_PSM       78
#define FAP4KE_PKT_CMDLISTS_IN_QSM       20
#else /* CC_FAP4KE_PKT_IPV6_SUPPORT */
/* 6362 IPV4, no BPM */
#define FAP4KE_PKT_MAX_DSP_FLOWS         78
#define FAP4KE_PKT_MAX_PSM_FLOWS         82
#define FAP4KE_PKT_MAX_QSM_FLOWS         0
#define FAP4KE_PKT_CMDLISTS_IN_PSM       126
#define FAP4KE_PKT_CMDLISTS_IN_QSM       34
#endif /* CC_FAP4KE_PKT_IPV6_SUPPORT */
#endif /* else BPM or IQ */
...
//    uint32 iqDropped;     /* packets dropped by Ingress QoS */
    uint8 iqPrio;        /* Ingress QoS packet priority */
#endif
    uint8 virtDestPort;
    uint16 virtDestPortMask;
    uint8 extSwTagLen;
...
typedef struct {
    ...
    int cmdOffset;
    uint32 vlanHdrCount;
    fap4kePkt_vlanHeader_t *learnedVlanHdr_p[FAP4KE_PKT_LEARN_MAX_VLAN_HEADERS];
...
typedef enum {
    ...
    FAP4KE_PKT_CMD_REPLACE_VLAN_HDR,
