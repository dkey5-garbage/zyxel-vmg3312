...
void kerSysEarlyFlashInit( void )
{
    ...
    flash_init();
    bootFromNand = 0;
    printk("Enter kerSysEarlyFlashInit: set bootFromNand = %d\n", bootFromNand);
...
//    char *pBuf = NULL;
    ...
    return sts;
#endif
    printk("Enter kerSysPersistentSet: bootFromNand = %d\n", bootFromNand);
...
//    char *pBuf = NULL;
    ...
    return sts;
#endif
    printk("Enter kerSysBackupPsiSet: bootFromNand = %d\n", bootFromNand);
...
//    char *pBuf = NULL;
    ...
    return sts;
#endif
    printk("Enter kerSysSyslogSet: bootFromNand = %d\n", bootFromNand);
...
int kerSysScratchPadSet(char *tokenId, char *tokBuf, int bufLen)
{
    ...
    if( bootFromNand )
        ...
        printk("Enter kerSysScratchPadSet: bootFromNand = %d\n", bootFromNand);
#else
    else
