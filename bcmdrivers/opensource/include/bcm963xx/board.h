...
#define BOARD_IOCTL_GET_GPIO            _IOWR(BOARD_IOCTL_MAGIC, 42, BOARD_IOCTL_PARMS)
#endif   
#if 1 /* Support the CLI command to test incorrect bad block tables(BBT), __CHT__, MitraStar SeanLu, 20140328 */
#define BOARD_IOCTL_BRCMNAND_BBT_READ             _IOWR(BOARD_IOCTL_MAGIC, 46, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_BRCMNAND_BBT_WRITE            _IOWR(BOARD_IOCTL_MAGIC, 47, BOARD_IOCTL_PARMS)
#endif
...
#endif
#ifdef BUILD_MLD_GLOB_TT_HOME_GW_AAWV_FEATURE //Bruce, MAC Addresses of PVCs should be constant for TT
extern int kerSysGetMacAddressForTT( unsigned char *pucaMacAddr, unsigned long ulId,  unsigned char *vlanName);
#endif
...
#if 1//MitraStar, Julian, GPIO
extern GPIO_STATE_t kerSysGetGpioState(int gpio);
#endif
