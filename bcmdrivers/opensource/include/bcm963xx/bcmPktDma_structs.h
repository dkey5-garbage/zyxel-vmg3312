...
typedef struct BcmPktDma_LocalXtmTxDma
{
    ...
    UINT32 ulDropped;
#endif
#if 0 //__MSTC, Eason, merge from 412L06, 412L06 precompiled fap does not allow modifications of structure BcmPktDma_LocalXtmTxDma				   	
#if 1 //__MTS, FuChia, for hardware queue rate monitor
	UINT32 passBytes;
	UINT32 passRate;
	UINT32 dropBytes;
	UINT32 dropRate;
#endif //__MTS, FuChia, for hardware queue rate monitor
#endif // __MSTC, Eason
