...
/* The timeout value to treat the dns query as expired */
#ifndef DNS_TIMEOUT 
#define DNS_TIMEOUT 10  //CSP#837738 patch_3
#endif

/* The max retry number when the query is failed. */
#define MAX_RETX_COUNT 3  //CSP#837738 patch_3

/* The depth of the dns query linked-list, limit the dnsproxy memory usage */
#define MAX_DNS_QUERY_ENTRY 1000  //CSP#837738 patch_3
