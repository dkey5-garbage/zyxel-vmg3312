...
#if 1
#define LOG_FILE_NEED_SAVE "/log/system_ns.log"
#define SECURITY_LOG_FILE_NEED_SAVE "/log/security_ns.log"
#define BROADCOM_LOG_FILE_NEED_SAVE "/log/brcm_ns.log"
#endif
...
void copyLogToFlash(char *logFilePath, char *flashLogFilePath, unsigned int logFileSize, int logFileRotate)
{
	...
	{
		fclose(dummyFP);   //_MSTC_, YingYu, syslog can not work.
		if((dummyFP = fopen(log_0_file,"r")) == NULL){
...
static void halt_reboot_pwoff(int sig)
{
	...
	if ( strcmp(m, "reboot") == 0 ) {
		copyLogToFlash(LOG_FILE_NEED_SAVE, FLASH_LOG_FILE, 100*1024, 5);
		copyLogToFlash(SECURITY_LOG_FILE_NEED_SAVE, SECURITY_FLASH_LOG_FILE, 100*1024, 5);
	}
#endif //__MSTC__, TengChang
