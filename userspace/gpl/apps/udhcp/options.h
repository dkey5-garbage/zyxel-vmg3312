...
#endif
#ifdef MSTC_DHCP_43
#define DHCP_OPTION_43_CODE 43
#define DHCP_OPTION_43_CODE_OFFSET 0
#define DHCP_OPTION_43_LEN_OFFSET  1
#define DHCP_OPTION_43_DATA_OFFSET 2
#define DHCP_OPTION_43_SUBCODE_AND_LEN_BYTES      2
#endif
#ifdef MSTC_DHCP_82	//_MSTC_, YingYu, Option 82
int createAGoption(char *AGinfo, char *chaddrptr);
/* The sub-option code (1~2) */ /* OPTION 82 */
