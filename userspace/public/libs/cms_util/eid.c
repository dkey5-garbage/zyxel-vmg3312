...
//__MSTC__, Nick Tseng, GUI Debug Mode with FTP
   ...
   {EID_SNTP,
    ...
    "/bin/sntp",
    "",                 /* run args */
#ifdef MLD_GLOB_TT_HOME_GW_FEATURE	/*__MSTC__, Linda, new WAN Interface_END. */
...
#endif
    0, 0, 0},
#ifdef MSTC_TURKEY_RETAIL_PPTP_VPN //jim
   {EID_PPTPD,//jim
    0,
    "pppd-2.4.4",
    "/bin/pppd-2.4.4",
...
{EID_OSGID,        /* eid */
   ...
   {EID_WPASUPPLICANT,
	...
	0, 0, 0},			/* misc memory parameters */
       ...
       0, 0, 0},           /* misc memory parameters */
#endif
#if defined(MSTC_TTNET_NO_LIMIT) && defined(MSTC_TTNET_MOBILE_APP) //__MSTC__,SUPPORT mobile app
      {EID_MOBILEAPP,
       NDA_ACCESS_HTTPD, /*set it has access bit same as httpd GUI interface*/
       "EmappS",
       "/bin/EmappS",
       "",                 /* run args */
       EIF_LAUNCH_ON_BOOT|EIF_MDM|EIF_MESSAGING_CAPABLE,  /* EIF_ flags */
       0,                  /* backlog for TCP server port */
       0,                  /* TCP/UDP server port */
       TRUE,               /* isFeatureCompiledIn */
       0, 0, 0},           /* misc memory parameters */
#endif
#ifdef MSTC_ASSIA_AGENT
		{EID_Assia_Agent,
		0, 
		"AssiaAgent",
		"/bin/do_cloudcheck.sh",
		"", 		 /* run args */
		EIF_LAUNCH_ON_BOOT|EIF_MDM|EIF_MESSAGING_CAPABLE,
		0,
		0,
		...
		0, 0, 0},
#endif
#ifdef SUPPORT_MSTC_MOBILE_APP  /* _MSTC_, support MSTC mobile app.*/
	{EID_MOBILED,
	NDA_ACCESS_HTTPD,
	"mobiled",
	"/bin/mobiled",
