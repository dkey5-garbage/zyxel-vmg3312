...
#define SECURITY_STATUS_FILE			"/var/security_status"
#define REMOTE_STATUS_FILE			"/var/remote_status"
...
typedef enum
{
   ...
   END_HOUR_MOBAPP,           
   START_MINUTE_MOBAPP,     
   END_MINUTE_MOBAPP=10,      
} ParentalCtlShceduleType;
#endif
