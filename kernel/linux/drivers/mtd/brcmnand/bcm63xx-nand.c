...
brcmnanddrv_setup_mtd_partitions(struct brcmnand_info* nandinfo)
{
    ...
    else
    {
        ...
        #if 1 /* MSTC_FWUP_FROM_FLASH */
        /* Add firmware upgrade partition */
        bcm63XX_nand_parts[3].offset = nvram.ulNandPartOfsKb[NP_FWUPGRADE] * 1024;
        bcm63XX_nand_parts[3].size = nvram.ulNandPartSizeKb[NP_FWUPGRADE] * 1024;
