...
MODULE_ALIAS("usb:v19D2p0020d*dc*dsc*dp*ic*isc*ip*");
...
MODULE_ALIAS("usb:v19D2p2000d*dc*dsc*dp*ic*isc*ip*");
...
MODULE_ALIAS("usb:v19D2p0015d*dc*dsc*dp*ic*isc*ip*");
MODULE_ALIAS("usb:v19D2p0149d*dc*dsc*dp*ic*isc*ip*");
...
MODULE_ALIAS("usb:v12D1p1003d*dc*dsc*dp*ic*isc*ip*");
...
MODULE_ALIAS("usb:v1D09p0FA3d*dc*dsc*dp*ic*isc*ip*");

MODULE_INFO(srcversion, "14A6A35FE380983C7202766");
